...
import { StrategyPerformanceChart } from './strategy-performance-chart'
import { AssetAllocationChart } from './asset-allocation-chart'
import { StrategyComparisonChart } from './strategy-comparison-chart'
import { RiskReturnScatterChart } from './risk-return-scatter-chart'
import { RealTimePriceChart } from './real-time-price-chart'
import { SystemHealth } from './system-health'
import { RecentSignals } from './recent-signals'
import { QuickActions } from './quick-actions'
import { CBSCTabPage } from '../cbsc/cbsc-tab-page'
import { Row, Col, Card, Progress, Typography, Button, Space, Tag } from '@/components/ui'
                ...
                <Row gutter={[16, 16]}>
                  ...
                  <Col xs={24} lg={8}>
                    <div className="space-y-4">
                      {/* 系統資源監控 */}
                      <Card title="系統資源使用情況" size="small">
                        <Row gutter={[16, 16]}>
                          <Col xs={24} sm={12}>
                            <div className="space-y-4">
                              <div>
...
import { DollarOutlined, RiseOutlined, TrophyOutlined, RocketOutlined } from '@ant-design/icons'
...
# -*- coding: utf-8 -*-
"""
Fixed Comprehensive Strategy Framework Test Suite
...
def run_basic_functionality_test():
    ...
    try:
        ...
        # Test strategy registration (without Direction enum)
        from comprehensive_strategy_framework import StrategyType
...
def run_parameter_optimization_test():
    ...
    try:
        from advanced_parameter_optimizer import AdvancedParameterOptimizer, OptimizationConfig, OptimizationAlgorithm, OptimizationObjective
        ...
        data = pd.DataFrame({
            'Open': base_prices,
            'High': base_prices + np.random.rand(100) * 2,
            'Low': base_prices - np.random.rand(100) * 2,
            'Close': base_prices + np.random.randn(100) * 0.1,
        ...
        print(f"[PASS] Optimization config: {optimization_config.algorithm.value}")
...
def run_market_state_detection_test():
    ...
    try:
        ...
        # Create test data (fixed the Series callable issue)
        dates = pd.date_range('2023-01-01', periods=100, freq='D')
        base_prices = 100 + np.random.randn(100).cumsum() * 0.5
        data = pd.DataFrame({
            'Open': base_prices,
...
def run_portfolio_optimization_test():
    ...
    try:
        ...
        # Test portfolio optimization (fixed the objective enum)
...
def main():
    ...
    if passed == total:
        ...
        print("- Basic functionality and imports working")
        print("- Scalability with multiple strategy instances")
        print("- Parameter optimization system functional")
        print("- Market state detection operational")
        print("- Portfolio optimization working")
        print("- Performance benchmarks satisfactory")
        return 0
    else:

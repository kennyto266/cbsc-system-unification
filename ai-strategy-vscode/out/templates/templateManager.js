...
class TemplateManager {
    ...
    createBreakoutTemplate() {
        const breakout = new notebookTemplate_1.NotebookTemplate('breakout', 'Classic breakout strategy with moving average confirmation');
        // Title cell
...
plt.show()`);
     ...
     */
    createMeanReversionTemplate() {
        const meanReversion = new notebookTemplate_1.NotebookTemplate('mean_reversion', 'Mean reversion strategy using Bollinger Bands');
        // Title cell

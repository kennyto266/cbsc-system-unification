...
def test_final_quick_actions():
    with sync_playwright() as p:
        ...
        print("=" * 60)
        print("Final Quick Actions Test")
        print("=" * 60)
        ...
        # 截圖初始狀態
        page.screenshot(path='final_dashboard_initial.png', full_page=True)
        ...
        if createBtn.count() > 0:
            ...
            if 'strategies?action=create' in current_url:
                ...
                page.screenshot(path='final_after_create.png')
        ...
        if marketBtn.count() > 0:
            ...
            try:
                ...
                # 截圖並關閉
                new_page.screenshot(path='final_market_data.png')
        ...
        print("\n[INFO] Browser will remain open for manual verification")
        print("[INFO] Close browser to end test")

...
def test_dashboard_components():
    ...
    try:
        ...
        # 测试各种图表
        charts.create_price_chart(demo_data)
        ...
        charts.create_returns_distribution(demo_data)
        logger.info("✓ Returns distribution created successfully")

        charts.create_drawdown_chart(demo_data)
        logger.info("✓ Drawdown chart created successfully")

        charts.create_correlation_heatmap(demo_data)
        logger.info("✓ Correlation heatmap created successfully")

        charts.create_monthly_returns_heatmap(demo_data)
...
def test_system_integration():
    ...
    try:
        ...
        logger.info(
            f"✓ Backtest completed: Return={result.total_return:.2%}, Sharpe={result.sharpe_ratio:.3f}"
        )
        ...
        charts.create_price_chart(data_to_use)

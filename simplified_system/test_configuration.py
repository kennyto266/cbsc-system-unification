...
def test_config_manager():
    ...
    try:
        ...
        print(
            f"✅ System Config: Environment={system_config.environment}, Debug={system_config.debug}"
        )
        ...
        print(
            f"✅ Government Data Sources: {len(data_config.government_data)} configured"
        )
...
def main():
    ...
    # 运行测试
    tests = [test_config_manager, test_stock_api, test_strategy_manager]

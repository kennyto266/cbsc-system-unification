...
class IntegratedSystemTest:
        ...
        for source_key, source_config in government_api.data_sources.items():
            ...
            try:
                ...
                params = {
                    "lang": "en",
                    "limit": "10",
                    "from": (datetime.now() - datetime.timedelta(days = 30)).strftime(
                        "%Y-%m-%d"
                    ),
                }
    ...
    def test_technical_indicators_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not stock_data.empty:
                ...
                indicators.calculate_macd(prices, 12, 26, 9)
                ...
                return {"status": "no_data", "error": "No stock data available"}
        ...
        try:
            ...
            if not stock_data.empty:
                ...
                if result:
                    ...
                    return {"status": "no_result", "error": "Backtest returned None"}
            else:
                return {
                    "status": "no_data",
    ...
    async def run_comprehensive_test(self) -> Dict[str, Any]:
        ...
        # 统计结果
        govt_success = sum(
            1 for r in government_results.values() if r.get("status") == "configured"
        )
        ...
        overall_status = (
            "PASS"
            if (
                govt_success == govt_total
                and indicators_results.get("status") == "success"
                and vectorbt_results.get("status") == "success"
            )
            else "FAIL"
        )
        ...
        report = {
            ...
            "test_modules": {
                "government_data_sources": {
                    ...
                    "success_rate": (
                        govt_success / govt_total * 100 if govt_total > 0 else 0
                    ),
            ...
            "integration_summary": {
                ...
                "indicators_working": indicators_results.get(

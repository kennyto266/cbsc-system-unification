...
def test_basic_functionality():
    ...
    try:
        ...
        config = StrategyCombinationConfig(
            max_strategies_per_combination = 4, optimization_method="sharpe_ratio"
        )
        ...
        StrategyCorrelationAnalyzer(correlation_config)
        ...
        StrategyAttributionAnalyzer(attribution_config)

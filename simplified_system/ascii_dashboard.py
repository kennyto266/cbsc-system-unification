            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.P(
                            f"Volatility: {processed_data['Returns'].std() * np.sqrt(252):.2%}"
                        ),
                    ],
                    className="four columns",
                    style={
                ...
                html.Div(
                    [
                        ...
                        html.P(
                            f"Annual Volatility: {processed_data['Returns'].std() * np.sqrt(252):.2%}"
                        ),
                        html.P(
...
def update_charts(period_days, indicators):
    ...
    returns_fig.update_layout(
        title="Cumulative Returns", xaxis_title="Date", yaxis_title="Returns (%)"
    )

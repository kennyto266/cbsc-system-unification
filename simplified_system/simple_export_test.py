...
def test_export_manager():
    ...
    try:
        ...
        # Test JSON export
        request = ExportRequest(data = test_data, format="json", filename="test_export")
        ...
        request = ExportRequest(
            data = pd.DataFrame(test_data), format="xlsx", filename="test_excel_export"
        )
        ...
        # Test CSV export
        request = ExportRequest(
            data = pd.DataFrame(test_data), format="csv", filename="test_csv_export"
        )
...
def test_pdf_export():
    ...
    try:
        ...
        test_data = {
            ...
            "summary": {"total_return": 0.156, "sharpe_ratio": 1.23},
        }

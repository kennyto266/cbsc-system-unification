...
class CompleteRealtimeAPI:
    ...
    def fetch_all_sources(self, limit: int = 1000) -> Dict[str, Any]:
        ...
        logger.info(
            f"Fetch complete: {successful_sources}/{len(self.api_endpoints)} sources, {total_records} total records"
        )
    ...
    def get_latest_records(
        self, source_name: str, count: int = 10
...
if __name__ == "__main__":
    ...
    print(
        "from complete_realtime_api import get_monetary_base, get_hibor_rates, get_all_government_data"
    )
    print()

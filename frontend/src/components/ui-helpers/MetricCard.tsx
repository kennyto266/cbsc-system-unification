 ...
 * Migrated from unified-dashboard square-ui with enhancements
 */
...
const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    ...
    >
      <Card
        className={cn(
          'relative overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer group',
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 dark:from-blue-900/20" />
        ...
        <div className="p-0 relative">
          ...
          <div className="flex items-baseline mb-3">
            <span className={cn(
              ...
              {formatValue(value)}
              {suffix && <span className="ml-1 text-gray-500 dark:text-gray-400">{suffix}</span>}
            </span>
          </div>
          ...
          {/* Decorative elements */}
          <div className="absolute -bottom-2 -right-2 w-24 h-24 bg-gradient-to-br from-blue-100/30 to-transparent rounded-full opacity-50 dark:from-blue-900/20" />
          <div className="absolute -top-1 -right-1 w-12 h-12 bg-gradient-to-br from-cyan-100/20 to-transparent rounded-full dark:from-cyan-900/10" />
        </div>
      </Card>
    </motion.div>
  )

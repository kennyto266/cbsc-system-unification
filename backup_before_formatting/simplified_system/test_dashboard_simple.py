...
def test_imports():
    ...
    try:
        ...
        from src.dashboard import PerformanceCharts, RealTimeUpdater, QuantDashboard
...
def test_performance_charts():
    ...
    try:
        ...
        # 测试各种图表
        price_chart = charts.create_price_chart(test_data)
        logger.info("Price chart created")

        radar_chart = charts.create_performance_radar()
        logger.info("Performance radar created")

        returns_chart = charts.create_returns_distribution(test_data)
        logger.info("Returns distribution created")

        drawdown_chart = charts.create_drawdown_chart(test_data)

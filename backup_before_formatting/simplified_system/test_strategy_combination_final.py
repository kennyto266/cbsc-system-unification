...
def test_basic_functionality():
    ...
    try:
        ...
        total_tests += 1
        from src.backtest.strategy_combination_optimizer import StrategyCombinationConfig, StrategyCombinationOptimizer

        config = StrategyCombinationConfig(
            max_strategies_per_combination=3,
        ...
        total_tests += 1
        from src.backtest.strategy_correlation import CorrelationConfig, StrategyCorrelationAnalyzer
        ...
        total_tests += 1
        from src.backtest.strategy_attribution import AttributionConfig, StrategyAttributionAnalyzer
        ...
        correlation_results = correlation_analyzer.analyze_correlations(strategy_returns)
        print(f"PASS: Correlation analysis completed with {len(correlation_results)} methods")
        success_count += 1
        ...
        print(f"PASS: Performance attribution completed, Information ratio: {attribution_result.information_ratio:.4f}")
        success_count += 1

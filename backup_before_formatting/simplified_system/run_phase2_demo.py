...
async def demo_phase2_authentication():
    ...
    try:
        ...
        authentic_count = sum(1 for r in batch_results if r.overall_verdict == Verdict.AUTHENTIC)
        ...
        if 'error' not in stats:
            ...
            print(f"   ⏱️  平均執行時間: {phase2_stats.get('average_execution_time_ms', 0):.2f}ms")
        else:

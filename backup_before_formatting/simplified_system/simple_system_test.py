...
def test_all_systems():
    ...
    try:
        ...
        williams_r = williams_r_result[0] if isinstance(williams_r_result, tuple) else williams_r_result
    ...
    try:
        ...
        test_results['end_to_end_workflow'] = {
            ...
            'final_signal': str(getattr(signals, 'signal_type', 'N/A')) if signals else 'N/A',

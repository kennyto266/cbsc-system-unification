...
def test_alpha_optimization():
    ...
    try:
        ...
        factor_types = [FactorTypes.MOMENTUM, FactorTypes.REVERSAL, FactorTypes.VOLATILITY]
    ...
    try:
        ...
        if selected_stocks:
            ...
            portfolio_metrics = portfolio_manager.calculate_portfolio_metrics(weights, returns_df)

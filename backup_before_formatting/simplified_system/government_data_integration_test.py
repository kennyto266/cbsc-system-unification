...
class GovernmentDataIntegrationTest:
    ...
    async def test_single_api(self, source: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"  [+] SUCCESS - {record_count} records in {execution_time:.2f}s")
                ...
                return {
                    ...
                    'params_used': params,
                    'data_sample': data if record_count <= 2 else {'records_sample': data.get('result', {}).get('records', [])[:2]}
                }
            else:
    ...
    async def run_all_tests(self) -> Dict[str, Any]:
        ...
        if successful == len(self.data_sources):
            ...
            print("[+] System ready for quantitative trading with real government data.")
        elif successful >= 6:

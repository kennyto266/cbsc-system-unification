...
def test_parameter_space():
    ...
    try:
        ...
        generated_combinations = rsi_space.generate_parameter_combinations(max_combinations=50)
...
def test_performance_evaluator():
    ...
    try:
        ...
        total_score, scores = evaluator.calculate_multi_objective_score(metrics, objectives)
...
def create_mock_result():
    ...
    MockResult = namedtuple('MockResult', [

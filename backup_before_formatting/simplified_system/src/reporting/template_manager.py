...
class TemplateManager:
    ...
    def list_templates(self, template_type: Optional[TemplateType] = None) -> List[TemplateConfig]:
        """
        列出模板
    ...
    def get_default_template(self, template_type: TemplateType) -> Optional[TemplateConfig]:
        """
        獲取默認模板
    ...
    def update_template(
        ...
        try:
            ...
            allowed_fields = ['description', 'version', 'css_files', 'js_files', 'variables', 'sections', 'is_active']
    ...
    def duplicate_template(self, source_name: str, new_name: str, description: Optional[str] = None) -> Optional[TemplateConfig]:
        """
        複製模板
    ...
    def preview_template(self, name: str, sample_data: Optional[Dict[str, Any]] = None) -> str:
        """
        預覽模板
...
<body>
    <div class="container">
        ...
        self.create_template(
            ...
            sections=["Header", "Performance Overview", "Strategy Details", "Charts", "Footer"]
        )

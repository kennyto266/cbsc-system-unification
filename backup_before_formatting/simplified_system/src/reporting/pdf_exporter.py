...
class PDFExporter:
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    self.logger.warning("No PDF library found. Please install weasyprint, pdfkit, or reportlab")
                    return None
    ...
    def _export_with_weasyprint(
        ...
        try:
            ...
            self.logger.info(f"PDF exported successfully with WeasyPrint: {output_path}")
            return True
    ...
    def _export_with_reportlab(
        ...
        try:
            ...
            c.setFont("Helvetica", 10)
            c.drawString(1 * inch, height - 2.5 * inch, f"Source HTML: {html_path.name}")
    ...
    def optimize_pdf(self, pdf_path: Union[str, Path]) -> bool:
        ...
        try:
            ...
            self.logger.info(f"PDF size: {new_size / 1024:.2f} KB (original: {original_size / 1024:.2f} KB)")
    ...
    def add_watermark(
        ...
        try:
            ...
            can.setFillColorRGB(0.9, 0.9, 0.9, alpha=0.3)  # Light gray, semi-transparent

...
class TestConfigManager(unittest.TestCase):
    ...
    def test_config_loading(self):
        ...
        # 测试基本配置加载
        self.assertEqual(
            self.config_manager.get("version"),
            "1.0.0"
        )

        # 测试嵌套配置获取
        self.assertEqual(
            self.config_manager.get("authenticity_manager.max_history_size"),
            500
        )
        ...
        self.assertEqual(
            self.config_manager.get("nonexistent.key", "default"),
            "default"
        )
    ...
    def test_config_setting(self):
        ...
        self.assertEqual(
            self.config_manager.get("new_key"),
            "new_value"
        )
    ...
    def test_verifier_config(self):
        ...
        self.assertFalse(self.config_manager.is_verifier_enabled("nonexistent_verifier"))
    ...
    def test_verifier_config_update(self):
        ...
        success = self.config_manager.update_verifier_config("test_verifier", new_config)
        self.assertTrue(success)

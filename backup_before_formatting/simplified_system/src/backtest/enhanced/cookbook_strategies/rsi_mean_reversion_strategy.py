...
def rsi_mean_reversion_strategy(price: pd.Series,
                               rsi_period: int = 14,
                               oversold: int = 30,
                               overbought: int = 70,
    ...
    logger.info(f"執行RSI均值回歸策略: RSI={rsi_period}, 超賣={oversold}, 超買={overbought}")
...
def optimize_rsi_strategy(price: pd.Series,
    ...
    logger.info(f"優化RSI策略: RSI={rsi_range}, 超賣={oversold_range}, 超買={overbought_range}")
...
def rsi_with_stop_loss_strategy(price: pd.Series,
                               rsi_period: int = 14,
                               oversold: int = 30,
                               overbought: int = 70,

...
class MPTOptimizer:
    ...
    def maximize_sharpe_ratio(
        ...
        try:
            logger.info(f"Starting Sharpe ratio maximization for {returns.shape[1]} assets")
            ...
            if result.success:
                ...
                # 計算風險貢獻
                marginal_contributions = self._calculate_marginal_contributions(weights, cov_matrix)
            ...
            logger.info(f"Sharpe ratio optimization completed in {optimization_result.calculation_time:.3f}s")
    ...
    def minimize_volatility(
        ...
        try:
            logger.info(f"Starting volatility minimization for {returns.shape[1]} assets")
            ...
            logger.info(f"Volatility minimization completed in {optimization_result.calculation_time:.3f}s")
            return optimization_result
    ...
    def target_return_optimization(
        ...
        try:
            logger.info(f"Starting target return optimization for {returns.shape[1]} assets")
            ...
            logger.info(f"Target return optimization completed in {optimization_result.calculation_time:.3f}s")
            return optimization_result
    ...
    def risk_parity_optimization(
        ...
        try:
            logger.info(f"Starting risk parity optimization for {returns.shape[1]} assets")
            ...
            logger.info(f"Risk parity optimization completed in {optimization_result.calculation_time:.3f}s")
            return optimization_result

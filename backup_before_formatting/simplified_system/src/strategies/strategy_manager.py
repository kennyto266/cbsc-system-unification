...
class StrategyManager:
    ...
    def optimize_strategy(
        ...
        logger.info(f"Starting optimization for {strategy_name}: {total_combinations} combinations")
        ...
        for params in strategy._generate_parameter_combinations(parameter_grid):
            ...
            if tested_combinations % 100 == 0:
                logger.info(f"Tested {tested_combinations}/{total_combinations} combinations")
    ...
    def compare_strategies(
        ...
        Returns:
            比较结果DataFrame
        """
        results = self.execute_multiple_strategies(strategy_names, data, parameters_dict)
    ...
    def get_strategy_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'last_execution': self.results_history[-1].timestamp if self.results_history else None
        }

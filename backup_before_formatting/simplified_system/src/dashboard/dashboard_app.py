...
class QuantDashboard:
        ...
        self.app.layout = dbc.Container([
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("控制面板", className="card-title"),
                            ...
                            dbc.Row([
                                dbc.Col([
                                    ...
                                    dcc.Dropdown(
                                        id='stock-selector',
                                        options=[
                                            {'label': '腾讯控股 (0700.HK)', 'value': '0700.HK'},
                                            {'label': '阿里巴巴 (09988.HK)', 'value': '09988.HK'},
                                            {'label': '美团 (03690.HK)', 'value': '03690.HK'},
                                            {'label': '小米集团 (01810.HK)', 'value': '01810.HK'},
                                            {'label': '港交所 (00388.HK)', 'value': '00388.HK'},
                                        ],
                                        value='0700.HK',
                                        multi=False
                                    )
                            ...
                            dbc.Row([
                                dbc.Col([
                                    ...
                                    dcc.Dropdown(
                                        ...
                                        options=[
                                            {'label': 'RSI均值回归', 'value': 'RSI_MEAN_REVERSION'},
                                            {'label': 'MACD交叉', 'value': 'MACD_CROSSOVER'},
                                            {'label': '布林带', 'value': 'BOLLINGER_BANDS'},
                                            {'label': '双移动平均', 'value': 'DUAL_MOVING_AVERAGE'},
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H4("总回报率", className="card-title"),
                            html.H2(id="total-return-metric", className="text-success"),
                            html.P("年化回报率", className="card-text"),
                            html.H4(id="annual-return-metric", className="text-primary")
                        ])
                    ])
                ], width=3),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H4("Sharpe比率", className="card-title"),
                            html.H2(id="sharpe-metric", className="text-info"),
                            html.P("最大回撤", className="card-text"),
                            html.H4(id="max-drawdown-metric", className="text-danger")
                        ])
                    ])
                ], width=3),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.H2(id="win-rate-metric", className="text-warning"),
                            html.P("总交易次数", className="card-text"),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H4("Calmar比率", className="card-title"),
                            html.H2(id="calmar-metric", className="text-secondary"),
                            html.P("Sortino比率", className="card-text"),
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H5("交易记录", className="card-title"),
    ...
    def register_callbacks(self):
        ...
        def run_backtest(n_clicks, data_json, strategy):
            ...
            try:
                ...
                return None, "错误", "错误", "错误", "错误", "错误", "错误", "错误", "错误"
        ...
        def update_charts(data_json, results_json, benchmark):
            ...
            try:
                ...
                correlation_fig = self.performance_charts.create_correlation_heatmap(data)

                monthly_fig = self.performance_charts.create_monthly_returns_heatmap(data)

                # 处理交易记录
                trades_data = self.extract_trades_data(results_json)

                return (
                    price_fig, radar_fig, returns_fig,
                    drawdown_fig, correlation_fig, monthly_fig, trades_data
                )
    ...
    def calculate_indicators(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            # RSI
            data_with_indicators['RSI_14'] = self.indicators.calculate_rsi(data['close'], 14)

            # 移动平均
            data_with_indicators['SMA_20'] = self.indicators.calculate_sma(data['close'], 20)
            data_with_indicators['SMA_50'] = self.indicators.calculate_sma(data['close'], 50)

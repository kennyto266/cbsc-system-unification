...
class QuantitativeVisualizationDashboard:
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        ...
                        html.H5("Quantitative Trading Visualization Platform",
            ...
            dcc.Loading(
                ...
                children=[
                    ...
                    dbc.Row([
                        dbc.Col([
                            dbc.Card([
                                dbc.CardHeader(html.H5("🎛️ 控制面板 Control Panel",
                                                      className="mb-0")),
                                dbc.CardBody([
                                    dbc.Row([
                                        # Stock selection
                                        dbc.Col([
                                            dbc.Label("選擇股票 Select Stock:"),
                                            dcc.Dropdown(
                                                id='stock-selector',
                                        ...
                                        # Time range
                                        dbc.Col([
                                            dbc.Label("時間範圍 Time Range:"),
                                            dcc.Dropdown(
                                                id='period-selector',
                                                options=[
                                                    {'label': '1個月 1M', 'value': 30},
                                                    {'label': '3個月 3M', 'value': 90},
                                                    {'label': '6個月 6M', 'value': 180},
                                                    {'label': '1年 1Y', 'value': 365},
                                                    {'label': '2年 2Y', 'value': 730},
                                                    {'label': '3年 3Y', 'value': 1095}
                                                ],
                                                value=365,
                                                className="mb-3"
                                            )
                                        ...
                                        # Chart type
                                        dbc.Col([
                                            dbc.Label("圖表類型 Chart Type:"),
                                            dcc.Dropdown(
                                                id='chart-type-selector',
                                                options=[
                                                    {'label': 'K線圖 Candlestick', 'value': 'candlestick'},
                                                    {'label': '技術指標 Technical', 'value': 'technical'},
                                                    {'label': '成交量 Volume', 'value': 'volume'},
                                                    {'label': '相關性 Correlation', 'value': 'correlation'}
                                                ],
                                                value='candlestick',
                                                className="mb-3"
                                            )
                                        ...
                                        dbc.Col([
                                            dbc.Label("更新 Update:"),
                                            dbc.Button(
                                                [html.I(className="bi bi-arrow-clockwise me-2"), "更新圖表"],
                                                id="update-button",
                                                color="primary",
                                    ...
                                    dbc.Row([
                                        dbc.Col([
                                            dbc.Label("技術指標 Technical Indicators:"),
                                            dcc.Checklist(
                                                ...
                                                options=[
                                                    ...
                                                    {'label': '布林帶 BB', 'value': 'BB'},
                                                    {'label': '成交量 Volume', 'value': 'Volume'}
                                                ],
                                                value=['MA5', 'MA20', 'RSI14', 'Volume'],
                                                className="mb-0"
                                            )
                                        ], width=12)
                                    ])
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            # Statistics Card
                            dbc.Card([
                                dbc.CardHeader(html.H6("📊 統計信息 Statistics",
                                                      className="mb-0")),
                                dbc.CardBody([
                            ...
                            dbc.Card([
                                dbc.CardHeader(html.H6("🔬 技術分析 Technical",
                                                      className="mb-0")),
                                dbc.CardBody([
                                    html.Div(id='technical-analysis-info')
                                ])
                            ], className="mb-3"),

                            # Risk Metrics Card
                            dbc.Card([
                                dbc.CardHeader(html.H6("⚠️ 風險指標 Risk Metrics",
                                                      className="mb-0")),
                                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            dbc.Tabs([
                                dbc.Tab(label="📈 投資組合 Portfolio", tab_id="portfolio"),
                                dbc.Tab(label="🔗 相關性 Correlation", tab_id="correlation"),
                                dbc.Tab(label="📊 回測分析 Backtest", tab_id="backtest")
                            ], id="analysis-tabs", active_tab="portfolio"),
                        ...
                        dbc.Col([
                            html.Div([
                                ...
                                html.P([
                                    ...
                                    html.Span(f"| Updated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}",
    ...
    def _setup_callbacks(self):
        ...
        def update_data(n_clicks, n_intervals, stock, period):
            ...
            try:
                ...
                if df is not None and not df.empty:
                    ...
                    indicators_json = df_indicators.reset_index().to_json('records', date_format='iso')
        ...
        def update_charts(data_json, indicators_json, chart_type, selected_indicators, stock):
            """更新所有圖表和信息面板

            Update all charts and information panels
            """
            if not data_json or not indicators_json:
                return {}, {}, {}, html.P("等待數據..."), html.P("等待數據..."), html.P("等待數據...")
            ...
            try:
                ...
                if chart_type == 'candlestick':
                    main_fig = self._create_candlestick_chart(df, df_indicators, selected_indicators, stock)
                elif chart_type == 'technical':
                    main_fig = self._create_technical_chart(df_indicators, selected_indicators, stock)
                ...
                # Indicators chart
                indicators_fig = self._create_indicators_chart(df_indicators, selected_indicators, stock)

                # Statistics info
                stats_info = self._generate_statistics_info(df, stock)

                # Technical analysis info
                technical_info = self._generate_technical_analysis_info(df_indicators, selected_indicators)

                # Risk metrics info
                risk_info = self._generate_risk_metrics_info(df, df_indicators)

                return main_fig, volume_fig, indicators_fig, stats_info, technical_info, risk_info
                ...
                return error_fig, {}, {}, html.P(f"Error: {str(e)}"), html.P("Error"), html.P("Error")
        ...
        try:
            if SIMPLIFIED_SYSTEM_AVAILABLE:
                ...
                if data is not None and not data.empty:
                    ...
                    data = data.rename(columns={col: standard for col, standard in column_mapping.items()
    ...
    def _calculate_indicators(self, df):
        ...
        # Bollinger Bands
        df_indicators['BB_upper'] = df_indicators['MA20'] + (df['Close'].rolling(window=20).std() * 2)
        df_indicators['BB_lower'] = df_indicators['MA20'] - (df['Close'].rolling(window=20).std() * 2)
        df_indicators['BB_middle'] = df_indicators['MA20']

        # Performance metrics
        df_indicators['Returns'] = df['Close'].pct_change()
        df_indicators['Cumulative_Returns'] = (1 + df_indicators['Returns']).cumprod() - 1

        # Drawdown
        cummax = df_indicators['Cumulative_Returns'].cummax()
        df_indicators['Drawdown'] = ((df_indicators['Cumulative_Returns'] / cummax) - 1) * 100
    ...
    def _create_volume_chart(self, df, stock):
        ...
        colors = [self.chart_templates['colors']['bull'] if close >= open else self.chart_templates['colors']['bear']
        ...
        for indicator in selected_indicators:
            if indicator in df_indicators.columns and indicator not in ['Volume']:
                if indicator == 'RSI14':
                    ...
                    fig.add_hline(y=70, line_dash="dash", line_color="red", annotation_text="超買")
                    fig.add_hline(y=30, line_dash="dash", line_color="green", annotation_text="超賣")
                elif indicator == 'MACD':
    ...
    def _generate_risk_metrics_info(self, df, df_indicators):
        ...
        try:
            ...
            max_drawdown = df_indicators['Drawdown'].min() if 'Drawdown' in df_indicators.columns else 0
            sharpe_ratio = (returns.mean() * 252 - 0.03) / (returns.std() * np.sqrt(252)) if returns.std() > 0 else 0
            ...
            return [
                ...
                html.P([html.Strong("最大回撤: "),
                       html.Span(f"{max_drawdown:.2%}",
                                style={'color': 'red' if max_drawdown < -0.1 else 'orange'})]),
                html.P([html.Strong("Sharpe比率: "),
                       html.Span(f"{sharpe_ratio:.3f}",
    ...
    def _create_correlation_analysis(self, df):
        ...
        return html.Div([
            ...
            html.P("Multi-asset correlation analysis requires loading multiple stocks data, this feature is under development...")
        ])
    ...
    def _create_backtest_analysis(self, df):
        ...
        return html.Div([
            ...
            html.P("Strategy backtesting functionality is under development, will support multiple trading strategy testing...")
        ])

...
class TestVectorizationEngine(unittest.TestCase):
    ...
    def test_multiple_source_vectorization(self):
        ...
        try:
            ...
            for source_id, data in vectorized_data.items():
                print(f"  {source_id}: {len(data.values)} records, dtype: {data.values.dtype}")
    ...
    def test_data_alignment(self):
        ...
        try:
            ...
            if len(aligned_data) > 1:
                ...
                all_same_length = all(len(df) == first_length for df in aligned_data.values())
                if all_same_length:
    ...
    def test_window_creation(self):
        ...
        try:
            ...
            # 創建窗口
            windows = self.vectorizer.create_windows(vectorized, window_size=30, step_size=15)
    ...
    def test_sequence_creation(self):
        ...
        try:
            ...
            # 創建序列
            X, y = self.vectorizer.create_sequences(vectorized, sequence_length=10, prediction_length=1)
    ...
    def test_scaling_methods(self):
        ...
        for method in scaling_methods:
            try:
                ...
                # 測試反向標準化
                if hasattr(vectorized, 'normalization_params') and vectorized.normalization_params:
                    ...
                    print(f"  Restored mean accuracy: {abs(original_mean - restored_mean):.6f}")
    ...
    def test_performance_benchmark(self):
        ...
        try:
            ...
            start_time = time.time()
            windows = self.vectorizer.create_windows(vectorized, window_size=100, step_size=50)
            ...
            print(f"Records per second (vectorization): {len(large_data)/vectorization_time:.0f}")

        ...
        for payload in xss_payloads:
            try:
                ...
                if response.status_code == 200:
                    ...
                    assert "javascript:" not in data.lower(), f"可能的XSS漏洞: {payload}"
        ...
        for endpoint in sensitive_endpoints:
            try:
                ...
                if response.status_code == 200:
                    ...
                    found_sensitive = [pattern for pattern in sensitive_patterns if pattern in data]
                    if found_sensitive:
        ...
        for payload in bypass_payloads:
            ...
            try:
                ...
                if response.status_code >= 400:
                    ...
                    found_errors = [error for error in database_errors if error in error_text]
                    if found_errors:

...
class TestCookbookIntegration(unittest.TestCase):
    ...
    def test_walkforward_optimizer_initialization(self):
        ...
        from simplified_system.src.backtest.enhanced.vectorbt_walkforward_optimizer import WalkForwardOptimizer, WalkForwardConfig
    ...
    def test_strategy_builder_initialization(self):
        """測試策略構建器初始化"""
        from simplified_system.src.backtest.enhanced.vectorbt_strategy_builder import CookbookStrategyBuilder
    ...
    def test_portfolio_analyzer_initialization(self):
        """測試投資組合分析器初始化"""
        from simplified_system.src.backtest.enhanced.vectorbt_portfolio_analyzer import AdvancedPortfolioAnalyzer, PortfolioAnalysisConfig
    ...
    def test_ma_crossover_optimization(self):
        """測試MA交叉策略優化"""
        from simplified_system.src.backtest.enhanced.cookbook_strategies.ma_crossover_strategy import optimize_ma_crossover
    ...
    def test_strategy_comparison(self):
        ...
        comparison_result = builder.compare_strategies(
            self.price_data,
            strategy_names=['MA_CROSSOVER', 'RSI_MEAN_REVERSION']
        )
    ...
    def test_rsi_strategy_optimization(self):
        """測試RSI策略優化"""
        from simplified_system.src.backtest.enhanced.cookbook_strategies.rsi_mean_reversion_strategy import optimize_rsi_strategy

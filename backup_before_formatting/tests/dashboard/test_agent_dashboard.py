...
from src.dashboard.agent_control import AgentControlConfig, AgentControlService
...
from src.dashboard.components.performance_charts import (
    PerformanceChartsComponent,
    PerformanceChartsConfig,
)
from src.dashboard.components.strategy_display import (
    StrategyDisplayComponent,
    StrategyDisplayConfig,
)
from src.dashboard.dashboard_ui import DashboardUI
from src.dashboard.performance_service import PerformanceConfig, PerformanceService
from src.dashboard.realtime_service import RealtimeConfig, RealtimeService
from src.dashboard.strategy_data_service import StrategyDataConfig, StrategyDataService
...
class TestStrategyDisplayComponent:
    ...
    def test_update_strategy(self, strategy_display_component):
        ...
        assert callback_called is True
        assert (
            strategy_display_component.get_current_strategy().strategy_id
            == "test_strategy"
        )
...
class TestDashboardIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_dashboard_initialization(
...
class TestDashboardPerformance:
    ...
    async def test_memory_usage(self, mock_coordinator, mock_message_queue):
        ...
        for i in range(50):
            ...
            backtest_metrics = (
                await dashboard_api.performance_service.calculate_strategy_performance(

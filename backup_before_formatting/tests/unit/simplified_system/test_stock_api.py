...
from src.api.stock_api import StockDataAPI, get_stock_data, get_hk_stock_data
...
class TestStockDataAPI:
    ...
    @patch('requests.get')
    def test_get_stock_prices_dataframe_success(self, mock_get, api_client, mock_response):
        """測試成功DataFrame轉換"""
        mock_get.return_value = mock_response
